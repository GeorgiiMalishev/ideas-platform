...
func (r *WorkerCoffeeShopRepositoryImpl) Create(workerShop *models.WorkerCoffeeShop) (*models.WorkerCoffeeShop, error) {
	if err := r.db.Create(workerShop).Error; err != nil {
		return nil, err
	}
	// Preload associated data for the returned object
	if err := r.db.Preload("Worker").Preload("CoffeeShop").First(workerShop).Error; err != nil {
		return nil, err
	}
...
func (r *WorkerCoffeeShopRepositoryImpl) GetByID(id uuid.UUID) (*models.WorkerCoffeeShop, error) {
...
func (r *WorkerCoffeeShopRepositoryImpl) ListByCoffeeShopID(coffeeShopID uuid.UUID, limit, offset int) ([]models.WorkerCoffeeShop, error) {
	var workers []models.WorkerCoffeeShop
	err := r.db.Preload("Worker").
...
func (r *WorkerCoffeeShopRepositoryImpl) ListByWorkerID(workerID uuid.UUID, limit, offset int) ([]models.WorkerCoffeeShop, error) {
	var coffeeShops []models.WorkerCoffeeShop
	err := r.db.Preload("CoffeeShop").
...
func (r *WorkerCoffeeShopRepositoryImpl) Update(workerShop *models.WorkerCoffeeShop) error {
	return r.db.Save(workerShop).Error
}

// Delete soft-deletes a worker-coffeeshop relationship
func (r *WorkerCoffeeShopRepositoryImpl) Delete(id uuid.UUID) error {
	result := r.db.Model(&models.WorkerCoffeeShop{}).Where("id = ?", id).
